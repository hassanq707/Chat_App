...
const ChatContainer = ({ setIsMedia }) => {
    ...
    return (
        <div className="relative flex flex-col h-full bg-[#0b2131]">

            <div className="fixed top-0 left-0 right-0 z-10 flex items-center justify-between px-4 py-3 border-b border-white/10 bg-[#0d283b]">
                <div className="flex items-center gap-3 relative">
            ...
            <div
                ref={messagesRef}
                className="flex-1 overflow-y-auto px-4 py-3 space-y-2 custom-scrollbar mt-[60px] mb-[72px]"
            >
                {loading ? <div className="flex justify-center items-center h-full bg-[#0b2131]">
                    <div className="w-8 h-8 border-4 border-blue-400 border-t-transparent rounded-full animate-spin"></div>
                </div>
            ...
            <div className="fixed bottom-0 left-0 right-0 z-10 px-4 py-3 border-t border-white/10 bg-[#0d283b]">
                {previewImage && (
                    <div className="mb-3 relative w-28 h-28 rounded overflow-hidden border border-white/20">
                        <img
                            src={previewImage}
