...
const MediaContainer = ({ setIsMedia }) => {
    ...
    return (
        <div className="w-full h-full flex flex-col bg-[#0b2131] text-white relative">
            {/* Header - Fixed on mobile, normal on desktop */}
            <div className="fixed top-0 left-0 right-0 z-50 md:sticky md:top-0 md:z-10 flex items-center gap-4 px-4 py-3.5 border-b border-white/10 bg-[#0d283b]">
                <i
                    className="ri-arrow-left-line text-2xl text-white/70 hover:text-white cursor-pointer"
                    onClick={() => setIsMedia(false)}
                ></i>
            ...
            {/* User Info - Fixed on mobile, normal on desktop */}
            <div className="fixed top-[60px] left-0 right-0 z-40 md:sticky md:top-0 md:z-10 flex items-center gap-4 px-4 py-4 border-b border-white/10 bg-[#0b2131] w-full">
                <img
                    src={selectedUser?.profilePic || '/images/default.png'}
                    alt="User"
                    className="w-14 h-14 md:w-16 md:h-16 rounded-full object-cover"
            ...
            {/* Media Content - Scrollable with proper padding */}
            <div className="flex flex-col overflow-y-auto flex-1 custom-scrollbar pt-[133px] pb-[76px] md:pt-2 md:pb-2">
            ...
            {/* Logout Button - Fixed on mobile, normal on desktop */}
